...
# Django settings for mebook2 project.
# -*- coding: utf-8 -*-
import os
...
DATABASES = {
    'default': {
        ...
        'USER': 'djangg',                      # Not used with sqlite3.
...
STATIC_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), '../static/mebook2'))


# URL prefix for static files.
# Example: "http://media.lawrence.com/static/"
STATIC_URL = '/static/mebook2/'
...
SECRET_KEY = 'zo3bvs-p_er^00r@$7-i9)k!9&amp;s-r)rzp31)qb$n&amp;(&amp;x5_49k+'
...
ROOT_URLCONF = 'mebook2.urls'
# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mebook2.wsgi.application'
